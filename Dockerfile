...
#Import Gudz
RUN wget https://raw.githubusercontent.com/hopepsycho/Black-userbot/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/hopepsycho/Black-userbot/master/requirements.txt
#Start Fumkin
