...
pm_caption = "➥ **𝔅𝔩𝔞𝔠𝔨 𝔲𝔰𝔢𝔯𝔟𝔬𝔱 IS:** `ONLINE`\n\n"
...
pm_caption += "➥ **Copyright** : By [hopepsycho@Github](GitHub.com/hopepsycho)\n"
pm_caption += "➥ **Check Stats By Doing** `.stat`. \n\n"
pm_caption += "[🇮🇳 Deploy 𝔅𝔩𝔞𝔠𝔨 𝔘𝔰𝔢𝔯𝔟𝔬𝔱 Userbot 🇮🇳](https://telegra.ph/)"
